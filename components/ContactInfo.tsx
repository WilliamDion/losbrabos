...
export const whatsappNumber = "5551980581593"

export default function Contact() {

  const instagramUser = "los_brabos_barbershop" 
  const address = "R. Túnel Verde, n° 04 - Balneário Pinhal, RS"
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-xl font-bold group-hover:text-primary transition-colors">(51) 98058-1593</p>
                </div>
              </a>
          ...
          <div className="w-full lg:w-1/2 h-[450px] relative group">
            ...
            <div className="relative z-10 w-full h-full bg-zinc-900 overflow-hidden rounded-sm grayscale invert contrast-[0.9] hover:grayscale-0 transition-all duration-700">
               <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110332.0491291336!2d-50.36220815664066!3d-30.2120711!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x951811dfddb5130b%3A0x786792e3e9a1b9cf!2sWal&#39;s%20Barber%20Shop!5e0!3m2!1spt-BR!2sbr!4v1770696241227!5m2!1spt-BR!2sbr" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
